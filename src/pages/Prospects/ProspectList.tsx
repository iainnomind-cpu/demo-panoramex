        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-outline-variant/30">
            {prospects.map((prospect) => {
              ...
              return (
                <tr key={prospect.id} className="hover:bg-surface-container-low/60 transition-colors">
                  <td className="px-6 py-4">
                    <button 
                      onClick={() => onProspectClick && onProspectClick(prospect.id)}
                      className="flex items-center gap-3 text-left hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-sm p-1 -ml-1"
